...
SamiVoid* 
SamiAdvisorsApi::createWithCompletion(String* vestorly-auth, String* advisor, void (* success)(SamiVoid*, SamiError*)) {
  ...
  String url(L"api/advisors.json");

  

  client->execute(SamiAdvisorsApi::getBasePath(), url, "POST", (IMap*)queryParams, mBody, (IMap*)headerParams, null, L"application/json");
  return null;
}
...
SamiVoid* 
SamiAdvisorsApi::showWithCompletion(String* vestorly-auth, String* _id, String* filter_by, void (* success)(SamiVoid*, SamiError*)) {
  client = new SamiApiClient();
  ...
  String url(L"api/advisors/{id}.json");
...
SamiVoid* 
SamiAdvisorsApi::updateWithCompletion(String* vestorly-auth, String* _id, void (* success)(SamiVoid*, SamiError*)) {
  client = new SamiApiClient();
  ...
  client->execute(SamiAdvisorsApi::getBasePath(), url, "PUT", (IMap*)queryParams, mBody, (IMap*)headerParams, null, L"application/json");
  return null;
}
