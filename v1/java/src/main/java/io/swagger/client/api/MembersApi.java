...
public class MembersApi {
  ...
  public Void index (String vestorly-auth, String advisor_id, String search, String sorted_by, String sorted_order) throws ApiException {
    ...
    String path = "api/advisors/{advisor_id}/members.json".replaceAll("\\{format\\}","json")
      .replaceAll("\\{" + "advisor_id" + "\\}", apiInvoker.escapeString(advisor_id.toString()));
  ...
  public Void create (String vestorly-auth, String advisor_id, String member) throws ApiException {
    ...
    if(contentType.startsWith("multipart/form-data")) {
      ...
      hasFields = true;
      mp.field("member", member, MediaType.MULTIPART_FORM_DATA_TYPE);
      
      if(hasFields)
        postBody = mp;
    }
    else {
      formParams.put("member", member);
  ...
  public Void show (String vestorly-auth, String advisor_id, String id) throws ApiException {
    ...
    // create path and map variables
    String path = "api/advisors/{advisor_id}/members/{id}.json".replaceAll("\\{format\\}","json")
      .replaceAll("\\{" + "advisor_id" + "\\}", apiInvoker.escapeString(advisor_id.toString()))
