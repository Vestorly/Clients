...
-(NSDictionary*) asDictionary {
    NSMutableDictionary* dict = [[NSMutableDictionary alloc] init];
            ...
            if(_high_net_worth != nil) dict[@"high_net_worth"] = _high_net_worth ;
        
    
    
            if(_home_market_value != nil) dict[@"home_market_value"] = _home_market_value ;
        
    
    
            if(_home_owner_status != nil) dict[@"home_owner_status"] = _home_owner_status ;
        
    
    
            if(_household_income != nil) dict[@"household_income"] = _household_income ;
        
    
    
            if(_marital_status != nil) dict[@"marital_status"] = _marital_status ;
        
    
    
            if(_occupation != nil) dict[@"occupation"] = _occupation ;
        
    
    
            if(_hometown != nil) dict[@"hometown"] = _hometown ;
        
    
    
            if(_family != nil) dict[@"family"] = _family ;
        
    
    
            if(_tags != nil) dict[@"tags"] = _tags ;
            ...
            if(_picture_url != nil) dict[@"picture_url"] = _picture_url ;
        
    
    
            if(_profile_url != nil) dict[@"profile_url"] = _profile_url ;
        
    
    
            if(_estimated_location != nil) dict[@"estimated_location"] = _estimated_location ;
        
    
    
            if(_estimated_zip != nil) dict[@"estimated_zip"] = _estimated_zip ;
        
    
    
            if(_register_ip_addr != nil) dict[@"register_ip_addr"] = _register_ip_addr ;
        
    
    
            if(_data_estimated != nil) dict[@"data_estimated"] = _data_estimated ;
        
    
    
            if(_genuine_email != nil) dict[@"genuine_email"] = _genuine_email ;
