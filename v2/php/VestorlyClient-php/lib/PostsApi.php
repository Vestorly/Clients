...
class PostsApi {
   ...
   */
   public function findPosts($vestorly_auth, $text_query, $external_url, $is_published) {
      ...
      if ($vestorly_auth === null) {
        throw new \InvalidArgumentException('Missing the required parameter $vestorly_auth when calling findPosts');
      }
      ...
      $responseObject = $this->apiClient->deserialize($response,'Posts');
   ...
   */
   public function createPost($vestorly_auth, $post) {
      ...
      // verify the required parameter 'vestorly_auth' is set
      if ($vestorly_auth === null) {
        throw new \InvalidArgumentException('Missing the required parameter $vestorly_auth when calling createPost');
      }
      
      // verify the required parameter 'post' is set
      if ($post === null) {
        throw new \InvalidArgumentException('Missing the required parameter $post when calling createPost');
      }
      ...
      $responseObject = $this->apiClient->deserialize($response,'Postresponse');
      return $responseObject;
  }
   ...
   */
   public function getPostByID($vestorly_auth, $id) {
      ...
      // verify the required parameter 'vestorly_auth' is set
      if ($vestorly_auth === null) {
        throw new \InvalidArgumentException('Missing the required parameter $vestorly_auth when calling getPostByID');
      }
      
      // verify the required parameter 'id' is set
      if ($id === null) {
        throw new \InvalidArgumentException('Missing the required parameter $id when calling getPostByID');
      }
   ...
   */
   public function updatePostByID($vestorly_auth, $id, $post) {
      ...
      // verify the required parameter 'vestorly_auth' is set
      if ($vestorly_auth === null) {
        throw new \InvalidArgumentException('Missing the required parameter $vestorly_auth when calling updatePostByID');
      }
      
      // verify the required parameter 'id' is set
      if ($id === null) {
        throw new \InvalidArgumentException('Missing the required parameter $id when calling updatePostByID');
      }
      
      // verify the required parameter 'post' is set
      if ($post === null) {
        throw new \InvalidArgumentException('Missing the required parameter $post when calling updatePostByID');
      }
