   ...
   */
   public function findMemberEvents($vestorly_auth) {
      ...
      if ($vestorly_auth === null) {
        throw new \InvalidArgumentException('Missing the required parameter $vestorly_auth when calling findMemberEvents');
      }
      ...
      $responseObject = $this->apiClient->deserialize($response,'MemberEvents');
