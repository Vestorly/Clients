...
class SessionsApi {
   ...
   */
   public function login($username, $password) {
      ...
      if ($username === null) {
        throw new \InvalidArgumentException('Missing the required parameter $username when calling login');
      }
      
      // verify the required parameter 'password' is set
      if ($password === null) {
        throw new \InvalidArgumentException('Missing the required parameter $password when calling login');
      }
      ...
      $responseObject = $this->apiClient->deserialize($response,'Session');
   ...
   */
   public function logout($vestorly_auth, $id) {
      ...
      if ($vestorly_auth === null) {
        throw new \InvalidArgumentException('Missing the required parameter $vestorly_auth when calling logout');
      }
      
      // verify the required parameter 'id' is set
      if ($id === null) {
        throw new \InvalidArgumentException('Missing the required parameter $id when calling logout');
      }
      ...
      $responseObject = $this->apiClient->deserialize($response,'SessionLogoutResponse');
      return $responseObject;
  }
