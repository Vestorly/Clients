...
class MembereventsApi(object):
    ...
    def findMemberEvents(self, **kwargs):
        """
        ...
        for (key, val) in params['kwargs'].iteritems():
            if key not in allParams:
                raise TypeError("Got an unexpected keyword argument '%s' to method findMemberEvents" % key)
            params[key] = val
        del params['kwargs']

        resourcePath = '/member_events'
        ...
        responseObject = self.apiClient.deserialize(response, 'MemberEvents')
