...
class MembersApi(object):
    ...
    def findMembers(self, **kwargs):
        ...
        for (key, val) in params['kwargs'].iteritems():
            if key not in allParams:
                raise TypeError("Got an unexpected keyword argument '%s' to method findMembers" % key)
            params[key] = val
        del params['kwargs']
        ...
        responseObject = self.apiClient.deserialize(response, 'Members')
        return responseObject
        
        
        
    
    def findMemberByID(self, **kwargs):
        """

        Args:
            
            id, str: Mongo ID of member to fetch (required)
        ...
        for (key, val) in params['kwargs'].iteritems():
            if key not in allParams:
                raise TypeError("Got an unexpected keyword argument '%s' to method findMemberByID" % key)
            params[key] = val
        del params['kwargs']
    ...
    def findMemberByID_1(self, **kwargs):
        """
        ...
        for (key, val) in params['kwargs'].iteritems():
            if key not in allParams:
                raise TypeError("Got an unexpected keyword argument '%s' to method findMemberByID_1" % key)
            params[key] = val
        del params['kwargs']
