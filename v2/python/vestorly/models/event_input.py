...
class EventInput(object):
    ...
    """
    def __init__(self, type=None, referer=None, original_url=None, originator_email=None, subject_email=None, parent_event_id=None, originator_id=None, advisor_id=None, subject_id=None, event_content=None, created_at=None):
        """
        EventInput - a model defined in Swagger
