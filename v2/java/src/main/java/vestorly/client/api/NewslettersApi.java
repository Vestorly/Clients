...
import vestorly.client.model.Newsletters;
import vestorly.client.model.Newsletterresponse;
import vestorly.client.model.NewsletterInput;
...
public class NewslettersApi {
  ...
  public Newsletters findNewsletters (String vestorlyAuth) throws ApiException {
    ...
    if (vestorlyAuth == null) {
       throw new ApiException(400, "Missing the required parameter 'vestorlyAuth' when calling findNewsletters");
    }
  ...
  public Newsletterresponse getNewsletterByID (String vestorlyAuth, String id) throws ApiException {
    ...
    // verify the required parameter 'vestorlyAuth' is set
    if (vestorlyAuth == null) {
       throw new ApiException(400, "Missing the required parameter 'vestorlyAuth' when calling getNewsletterByID");
    }
    
    // verify the required parameter 'id' is set
    if (id == null) {
       throw new ApiException(400, "Missing the required parameter 'id' when calling getNewsletterByID");
    }
  ...
  public Newsletterresponse updateNewsletterByID (String vestorlyAuth, String id, NewsletterInput newsletter) throws ApiException {
    ...
    // verify the required parameter 'vestorlyAuth' is set
    if (vestorlyAuth == null) {
       throw new ApiException(400, "Missing the required parameter 'vestorlyAuth' when calling updateNewsletterByID");
    }
    
    // verify the required parameter 'id' is set
    if (id == null) {
       throw new ApiException(400, "Missing the required parameter 'id' when calling updateNewsletterByID");
    }
    
    // verify the required parameter 'newsletter' is set
    if (newsletter == null) {
       throw new ApiException(400, "Missing the required parameter 'newsletter' when calling updateNewsletterByID");
    }
