...
import vestorly.client.model.Events;
import vestorly.client.model.Eventcreateresponse;
import vestorly.client.model.EventInput;
import vestorly.client.model.Eventresponse;
...
public class EventsApi {
  ...
  public Events findEvents (String vestorlyAuth) throws ApiException {
    ...
    if (vestorlyAuth == null) {
       throw new ApiException(400, "Missing the required parameter 'vestorlyAuth' when calling findEvents");
    }
   ...
   */
  public Eventcreateresponse createEvent (String vestorlyAuth, EventInput event) throws ApiException {
    Object postBody = event;
    
    // verify the required parameter 'vestorlyAuth' is set
    if (vestorlyAuth == null) {
       throw new ApiException(400, "Missing the required parameter 'vestorlyAuth' when calling createEvent");
    }
    ...
    try {
      ...
      if(response != null){
        return (Eventcreateresponse) ApiInvoker.deserialize(response, "", Eventcreateresponse.class);
      }
      else {
        return null;
      }
  ...
  public Eventresponse findEventByID (String id, String vestorlyAuth) throws ApiException {
    ...
    // verify the required parameter 'vestorlyAuth' is set
    if (vestorlyAuth == null) {
       throw new ApiException(400, "Missing the required parameter 'vestorlyAuth' when calling findEventByID");
    }
