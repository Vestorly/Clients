...
public class PostsApi {
  ...
  public Void index (String vestorly-auth, String is_published, String external_url_source, String ids) throws ApiException {
    ...
    String path = "api/posts.json".replaceAll("\\{format\\}","json");
  ...
  public Void create (String post) throws ApiException {
    Object postBody = null;
    ...
    if(contentType.startsWith("multipart/form-data")) {
      ...
      hasFields = true;
      mp.field("post", post, MediaType.MULTIPART_FORM_DATA_TYPE);
  ...
  public Void show (String vestorly-auth, String id) throws ApiException {
    ...
    // create path and map variables
    String path = "api/posts/{id}.json".replaceAll("\\{format\\}","json")
  ...
  public Void update (String id, String post) throws ApiException {
    Object postBody = null;
