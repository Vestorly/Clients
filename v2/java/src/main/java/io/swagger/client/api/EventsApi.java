...
public class EventsApi {
  ...
  public Void index (String vestorly-auth) throws ApiException {
    Object postBody = null;
    

    // create path and map variables
    String path = "api/events.json".replaceAll("\\{format\\}","json");
  ...
  public Void create (String event) throws ApiException {
    Object postBody = null;
    ...
    if(contentType.startsWith("multipart/form-data")) {
      ...
      hasFields = true;
      mp.field("event", event, MediaType.MULTIPART_FORM_DATA_TYPE);
  ...
  public Void show (String vestorly-auth, String id) throws ApiException {
    ...
    // create path and map variables
    String path = "api/events/{id}.json".replaceAll("\\{format\\}","json")
  ...
  public Void update (String id, String event) throws ApiException {
    Object postBody = null;
