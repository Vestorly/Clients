...
namespace io.swagger.Api {
  ...
  public class MemberreportsApi {
    ...
    public MemberReports  findMemberReports (string VestorlyAuth) {
      ...
      var path = "/member_reports".Replace("{format}","json");
      ...
      try {
        if (typeof(MemberReports) == typeof(byte[])) {
          
          var response = apiInvoker.invokeBinaryAPI(basePath, path, "GET", queryParams, null, headerParams, formParams);
          return ((object)response) as MemberReports;
          ...
          if (response != null){
             return (MemberReports) ApiInvoker.deserialize(response, typeof(MemberReports));
          }
          else {
            return null;
          }
