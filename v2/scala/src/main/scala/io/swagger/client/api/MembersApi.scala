...
class MembersApi(val defBasePath: String = "https://staging.vestorly.com/api/v2",
   ...
   * @return Members
   */
  def findMembers (vestorlyAuth: String) : Option[Members] = {
   ...
   */
  def createMember (vestorlyAuth: String, member: Member) : Option[Memberresponse] = {
    // create path and map variables
    val path = "/members".replaceAll("\\{format\\}","json")
   ...
   * @return Memberresponse
   */
  def findMemberByID (id: String, vestorlyAuth: String) : Option[Memberresponse] = {
    // create path and map variables
   ...
   * @return Memberresponse
   */
  def updateMemberByID (id: String, vestorlyAuth: String, member: Member) : Option[Memberresponse] = {
    // create path and map variables
    val path = "/members/{id}".replaceAll("\\{format\\}","json").replaceAll("\\{" + "id" + "\\}",apiInvoker.escape(id))
