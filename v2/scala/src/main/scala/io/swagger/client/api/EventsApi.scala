...
class EventsApi(val defBasePath: String = "https://staging.vestorly.com/api/v2",
   ...
   * @return Events
   */
  def findEvents (vestorlyAuth: String) : Option[Events] = {
   ...
   */
  def createEvent (vestorlyAuth: String, event: EventInput) : Option[Eventcreateresponse] = {
    // create path and map variables
    val path = "/events".replaceAll("\\{format\\}","json")
    ...
    try {
      apiInvoker.invokeApi(basePath, path, "POST", queryParams.toMap, formParams.toMap, postBody, headerParams.toMap, contentType) match {
        case s: String =>
           Some(ApiInvoker.deserialize(s, "", classOf[Eventcreateresponse]).asInstanceOf[Eventcreateresponse])
   ...
   */
  def findEventByID (id: String, vestorlyAuth: String) : Option[Eventresponse] = {
    // create path and map variables
