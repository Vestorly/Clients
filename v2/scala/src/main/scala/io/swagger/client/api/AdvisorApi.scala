...
class AdvisorApi(val defBasePath: String = "https://staging.vestorly.com/api/v2",
  ...
  def findAdvisorByID (id: String, vestorly-auth: String) : Option[Advisor] = {
    ...
    val path = "/advisor/{id}".replaceAll("\\{format\\}","json").replaceAll("\\{" + "id" + "\\}",apiInvoker.escape(id))
