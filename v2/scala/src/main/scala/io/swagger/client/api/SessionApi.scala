...
class SessionApi(val defBasePath: String = "https://staging.vestorly.com/api/v2",
  ...
  def logout (vestorly-auth: String) : Option[Session] = {
    // create path and map variables
    val path = "/sessions/m".replaceAll("\\{format\\}","json")
