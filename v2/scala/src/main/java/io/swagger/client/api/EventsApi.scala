...
class EventsApi(val defBasePath: String = "http://api.vestorly.com/",
  ...
  def index (vestorly-auth: String) : Option[Void] = {
    // create path and map variables
    val path = "api/events.json".replaceAll("\\{format\\}","json")
  ...
  def create (event: String) : Option[Void] = {
    // create path and map variables
    val path = "api/events.json".replaceAll("\\{format\\}","json")
  ...
  def show (vestorly-auth: String, id: String) : Option[Void] = {
    // create path and map variables
    val path = "api/events/{id}.json".replaceAll("\\{format\\}","json").replaceAll("\\{" + "id" + "\\}",apiInvoker.escape(id))
  ...
  def update (id: String, event: String) : Option[Void] = {
    // create path and map variables
    val path = "api/events/{id}.json".replaceAll("\\{format\\}","json").replaceAll("\\{" + "id" + "\\}",apiInvoker.escape(id))
