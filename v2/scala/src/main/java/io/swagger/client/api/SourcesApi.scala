...
class SourcesApi(val defBasePath: String = "http://developers.vestorly.com/",
  ...
  def index (vestorly-auth: String, ids: String) : Option[Void] = {
    ...
    val path = "api/sources.json".replaceAll("\\{format\\}","json")
  ...
  def show (vestorly-auth: String, id: String) : Option[Void] = {
    // create path and map variables
    val path = "api/sources/{id}.json".replaceAll("\\{format\\}","json").replaceAll("\\{" + "id" + "\\}",apiInvoker.escape(id))
  ...
  def update (id: String, source: String) : Option[Void] = {
    // create path and map variables
    val path = "api/sources/{id}.json".replaceAll("\\{format\\}","json").replaceAll("\\{" + "id" + "\\}",apiInvoker.escape(id))
