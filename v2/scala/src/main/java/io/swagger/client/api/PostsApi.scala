...
class PostsApi(val defBasePath: String = "http://api.vestorly.com/",
  ...
  def index (vestorly-auth: String, is_published: String, external_url_source: String, ids: String) : Option[Void] = {
    ...
    val path = "api/posts.json".replaceAll("\\{format\\}","json")
  ...
  def create (post: String) : Option[Void] = {
    // create path and map variables
    val path = "api/posts.json".replaceAll("\\{format\\}","json")
  ...
  def show (vestorly-auth: String, id: String) : Option[Void] = {
    // create path and map variables
    val path = "api/posts/{id}.json".replaceAll("\\{format\\}","json").replaceAll("\\{" + "id" + "\\}",apiInvoker.escape(id))
  ...
  def update (id: String, post: String) : Option[Void] = {
    // create path and map variables
    val path = "api/posts/{id}.json".replaceAll("\\{format\\}","json").replaceAll("\\{" + "id" + "\\}",apiInvoker.escape(id))
