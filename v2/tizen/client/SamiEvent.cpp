...
SamiEvent::fromJsonObject(IJsonValue* pJson) {
    ...
    if(pJsonObject != null) {
        ...
        if(pTypeVal != null) {
            ...
            pType = new SamiSymbol();
            jsonToValue(pType, pTypeVal, L"SamiSymbol", L"SamiSymbol");
        }
        delete pTypeKey;
...
SamiEvent::asJsonObject() {
    ...
    JsonString *pTypeKey = new JsonString(L"type");
    pJsonObject->Add(pTypeKey, toJson(getType(), "SamiSymbol", ""));

    
    JsonString *pReferrerKey = new JsonString(L"referrer");
    pJsonObject->Add(pReferrerKey, toJson(getReferrer(), "String", ""));

    
    JsonString *pOriginal_urlKey = new JsonString(L"original_url");
    pJsonObject->Add(pOriginal_urlKey, toJson(getOriginal_url(), "String", ""));

    
    JsonString *pOriginator_emailKey = new JsonString(L"originator_email");
    pJsonObject->Add(pOriginator_emailKey, toJson(getOriginator_email(), "String", ""));

    
    JsonString *pSubject_emailKey = new JsonString(L"subject_email");
    pJsonObject->Add(pSubject_emailKey, toJson(getSubject_email(), "String", ""));

    
    JsonString *pAdvisor_emailKey = new JsonString(L"advisor_email");
    pJsonObject->Add(pAdvisor_emailKey, toJson(getAdvisor_email(), "String", ""));

    
    JsonString *pOriginator_group_nameKey = new JsonString(L"originator_group_name");
    pJsonObject->Add(pOriginator_group_nameKey, toJson(getOriginator_group_name(), "String", ""));

    
    JsonString *pNewsletterKey = new JsonString(L"newsletter");
    pJsonObject->Add(pNewsletterKey, toJson(getNewsletter(), "String", ""));
...
void
SamiEvent::setType(SamiSymbol* pType) {
    this->pType = pType;
}

String*
SamiEvent::getReferrer() {
    return pReferrer;
}
void
SamiEvent::setReferrer(String* pReferrer) {
    this->pReferrer = pReferrer;
}

String*
SamiEvent::getOriginal_url() {
    return pOriginal_url;
}
void
SamiEvent::setOriginal_url(String* pOriginal_url) {
    this->pOriginal_url = pOriginal_url;
}

String*
SamiEvent::getOriginator_email() {
    return pOriginator_email;
}
void
SamiEvent::setOriginator_email(String* pOriginator_email) {
    this->pOriginator_email = pOriginator_email;
}

String*
SamiEvent::getSubject_email() {
    return pSubject_email;
}
void
SamiEvent::setSubject_email(String* pSubject_email) {
    this->pSubject_email = pSubject_email;
}

String*
SamiEvent::getAdvisor_email() {
    return pAdvisor_email;
}
void
SamiEvent::setAdvisor_email(String* pAdvisor_email) {
    this->pAdvisor_email = pAdvisor_email;
}

String*
SamiEvent::getOriginator_group_name() {
    return pOriginator_group_name;
}
void
SamiEvent::setOriginator_group_name(String* pOriginator_group_name) {
    this->pOriginator_group_name = pOriginator_group_name;
}

String*
SamiEvent::getNewsletter() {
    return pNewsletter;
}
void
SamiEvent::setNewsletter(String* pNewsletter) {
