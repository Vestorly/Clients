...
SamiVoid* 
SamiPostsApi::indexWithCompletion(String* vestorly-auth, String* is_published, String* external_url_source, String* ids, void (* success)(SamiVoid*, SamiError*)) {
...
SamiVoid* 
SamiPostsApi::createWithCompletion(String* post, void (* success)(SamiVoid*, SamiError*)) {
  client = new SamiApiClient();
...
SamiVoid* 
SamiPostsApi::showWithCompletion(String* vestorly-auth, String* _id, void (* success)(SamiVoid*, SamiError*)) {
  client = new SamiApiClient();
  ...
  String url(L"api/posts/{id}.json");
...
SamiVoid* 
SamiPostsApi::updateWithCompletion(String* _id, String* post, void (* success)(SamiVoid*, SamiError*)) {
  client = new SamiApiClient();
...
SamiVoid* 
SamiPostsApi::destroyWithCompletion(String* _id, void (* success)(SamiVoid*, SamiError*)) {
  client = new SamiApiClient();
