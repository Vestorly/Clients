...
SamiGroupInput*
SamiGroupInput::fromJson(String* json) {
    this->cleanup();
...
void
SamiGroupInput::fromJsonObject(IJsonValue* pJson) {
...
SamiGroupInput::SamiGroupInput(String* json) {
    init();
    String str(json->GetPointer());
    int length = str.GetLength();
...
String*
SamiGroupInput::getPId() {
    return p_id;
}
void
SamiGroupInput::setPId(String* p_id) {
    this->p_id = p_id;
}

String*
SamiGroupInput::getPName() {
    return pName;
}
void
SamiGroupInput::setPName(String* pName) {
    this->pName = pName;
}

Boolean*
SamiGroupInput::getPIsDefault() {
    return pIs_default;
}
void
SamiGroupInput::setPIsDefault(Boolean* pIs_default) {
    this->pIs_default = pIs_default;
}

Boolean*
SamiGroupInput::getPIsHidden() {
    return pIs_hidden;
}
void
SamiGroupInput::setPIsHidden(Boolean* pIs_hidden) {
    this->pIs_hidden = pIs_hidden;
}

String*
SamiGroupInput::getPNewWeeklyMailerContent() {
    return pNew_weekly_mailer_content;
}
void
SamiGroupInput::setPNewWeeklyMailerContent(String* pNew_weekly_mailer_content) {
    this->pNew_weekly_mailer_content = pNew_weekly_mailer_content;
}

String*
SamiGroupInput::getPNewsletterSubject() {
    return pNewsletter_subject;
}
void
SamiGroupInput::setPNewsletterSubject(String* pNewsletter_subject) {
    this->pNewsletter_subject = pNewsletter_subject;
}

Boolean*
SamiGroupInput::getPAutopublish() {
    return pAutopublish;
}
void
SamiGroupInput::setPAutopublish(Boolean* pAutopublish) {
    this->pAutopublish = pAutopublish;
}

Integer*
SamiGroupInput::getPNumberArticlesPerGroup() {
    return pNumber_articles_per_group;
}
void
SamiGroupInput::setPNumberArticlesPerGroup(Integer* pNumber_articles_per_group) {
    this->pNumber_articles_per_group = pNumber_articles_per_group;
}

Integer*
SamiGroupInput::getPNumberArticlesPerNewsletter() {
    return pNumber_articles_per_newsletter;
}
void
SamiGroupInput::setPNumberArticlesPerNewsletter(Integer* pNumber_articles_per_newsletter) {
