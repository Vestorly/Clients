...
SamiVoid* 
SamiEventsApi::indexWithCompletion(String* vestorly-auth, void (* success)(SamiVoid*, SamiError*)) {
...
SamiVoid* 
SamiEventsApi::createWithCompletion(String* event, void (* success)(SamiVoid*, SamiError*)) {
  client = new SamiApiClient();
...
SamiVoid* 
SamiEventsApi::showWithCompletion(String* vestorly-auth, String* _id, void (* success)(SamiVoid*, SamiError*)) {
  client = new SamiApiClient();
  ...
  String url(L"api/events/{id}.json");
...
SamiVoid* 
SamiEventsApi::updateWithCompletion(String* _id, String* event, void (* success)(SamiVoid*, SamiError*)) {
  client = new SamiApiClient();
