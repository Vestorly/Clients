...
String*
SamiPost::getPCreatedAt() {
    return pCreated_at;
}
void
SamiPost::setPCreatedAt(String* pCreated_at) {
    this->pCreated_at = pCreated_at;
}

String*
SamiPost::getPUpdatedAt() {
    return pUpdated_at;
}
void
SamiPost::setPUpdatedAt(String* pUpdated_at) {
    this->pUpdated_at = pUpdated_at;
}

String*
SamiPost::getPExternalUrl() {
    return pExternal_url;
}
void
SamiPost::setPExternalUrl(String* pExternal_url) {
    this->pExternal_url = pExternal_url;
}

String*
SamiPost::getPExternalUrlSource() {
    return pExternal_url_source;
}
void
SamiPost::setPExternalUrlSource(String* pExternal_url_source) {
    this->pExternal_url_source = pExternal_url_source;
}

String*
SamiPost::getPExternalUrlType() {
    return pExternal_url_type;
}
void
SamiPost::setPExternalUrlType(String* pExternal_url_type) {
    this->pExternal_url_type = pExternal_url_type;
}

String*
SamiPost::getPImagePath() {
    return pImage_path;
}
void
SamiPost::setPImagePath(String* pImage_path) {
...
String*
SamiPost::getPImageHeight() {
    return pImage_height;
}
void
SamiPost::setPImageHeight(String* pImage_height) {
    this->pImage_height = pImage_height;
}

String*
SamiPost::getPImageWidth() {
    return pImage_width;
}
void
SamiPost::setPImageWidth(String* pImage_width) {
    this->pImage_width = pImage_width;
}

String*
SamiPost::getPLogoUrl() {
    return pLogo_url;
}
void
SamiPost::setPLogoUrl(String* pLogo_url) {
    this->pLogo_url = pLogo_url;
}

String*
SamiPost::getPSquareLogoUrl() {
    return pSquare_logo_url;
}
void
SamiPost::setPSquareLogoUrl(String* pSquare_logo_url) {
    this->pSquare_logo_url = pSquare_logo_url;
}

String*
SamiPost::getPNeedsSanitize() {
    return pNeeds_sanitize;
}
void
SamiPost::setPNeedsSanitize(String* pNeeds_sanitize) {
    this->pNeeds_sanitize = pNeeds_sanitize;
}

String*
SamiPost::getPSummary() {
    return pSummary;
}
void
SamiPost::setPSummary(String* pSummary) {
...
String*
SamiPost::getPApprovalStatus() {
    return pApproval_status;
}
void
SamiPost::setPApprovalStatus(String* pApproval_status) {
    this->pApproval_status = pApproval_status;
}

String*
SamiPost::getPApprovalTransactions() {
    return pApproval_transactions;
}
void
SamiPost::setPApprovalTransactions(String* pApproval_transactions) {
    this->pApproval_transactions = pApproval_transactions;
}

IList*
SamiPost::getPGroupIds() {
    return pGroup_ids;
}
void
SamiPost::setPGroupIds(IList* pGroup_ids) {
...
void
SamiPost::setPSlug(String* pSlug) {
    this->pSlug = pSlug;
}

String*
SamiPost::getPArticleId() {
    return pArticle_id;
}
void
SamiPost::setPArticleId(String* pArticle_id) {
...
IList*
SamiPost::getPNewsletterIds() {
    return pNewsletter_ids;
}
void
SamiPost::setPNewsletterIds(IList* pNewsletter_ids) {
    this->pNewsletter_ids = pNewsletter_ids;
}

Boolean*
SamiPost::getPIsFeatured() {
    return pIs_featured;
}
void
SamiPost::setPIsFeatured(Boolean* pIs_featured) {
    this->pIs_featured = pIs_featured;
}

String*
SamiPost::getPAdvisorId() {
    return pAdvisor_id;
}
void
SamiPost::setPAdvisorId(String* pAdvisor_id) {
    this->pAdvisor_id = pAdvisor_id;
}

Boolean*
SamiPost::getPIsPublished() {
    return pIs_published;
}
void
SamiPost::setPIsPublished(Boolean* pIs_published) {
    this->pIs_published = pIs_published;
}

Boolean*
SamiPost::getPIsResponsive() {
    return pIs_responsive;
}
void
SamiPost::setPIsResponsive(Boolean* pIs_responsive) {
    this->pIs_responsive = pIs_responsive;
}

Boolean*
SamiPost::getPIsProxyNeeded() {
    return pIs_proxy_needed;
}
void
SamiPost::setPIsProxyNeeded(Boolean* pIs_proxy_needed) {
    this->pIs_proxy_needed = pIs_proxy_needed;
}

Boolean*
SamiPost::getPIsMobileProxyNeeded() {
    return pIs_mobile_proxy_needed;
}
void
SamiPost::setPIsMobileProxyNeeded(Boolean* pIs_mobile_proxy_needed) {
    this->pIs_mobile_proxy_needed = pIs_mobile_proxy_needed;
}

String*
SamiPost::getPProxyUrl() {
    return pProxy_url;
}
void
SamiPost::setPProxyUrl(String* pProxy_url) {
...
String*
SamiPost::getPPdfAttachmentUrl() {
    return pPdf_attachment_url;
}
void
SamiPost::setPPdfAttachmentUrl(String* pPdf_attachment_url) {
...
String*
SamiPost::getPDisplayDate() {
    return pDisplay_date;
}
void
SamiPost::setPDisplayDate(String* pDisplay_date) {
    this->pDisplay_date = pDisplay_date;
}

String*
SamiPost::getPSuitabilityScore() {
    return pSuitability_score;
}
void
SamiPost::setPSuitabilityScore(String* pSuitability_score) {
    this->pSuitability_score = pSuitability_score;
}

String*
SamiPost::getPVideoId() {
    return pVideo_id;
}
void
SamiPost::setPVideoId(String* pVideo_id) {
    this->pVideo_id = pVideo_id;
}

String*
SamiPost::getPDisplayTag() {
    return pDisplay_tag;
}
void
SamiPost::setPDisplayTag(String* pDisplay_tag) {
    this->pDisplay_tag = pDisplay_tag;
}

String*
SamiPost::getPDisplaySummary() {
    return pDisplay_summary;
}
void
SamiPost::setPDisplaySummary(String* pDisplay_summary) {
