...
SamiSourceInput::SamiSourceInput() {
    init();
}
...
SamiSourceInput*
SamiSourceInput::fromJson(String* json) {
    this->cleanup();
...
void
SamiSourceInput::fromJsonObject(IJsonValue* pJson) {
...
SamiSourceInput::SamiSourceInput(String* json) {
    init();
    String str(json->GetPointer());
    int length = str.GetLength();
...
String*
SamiSourceInput::getPName() {
    return pName;
}
void
SamiSourceInput::setPName(String* pName) {
    this->pName = pName;
}

String*
SamiSourceInput::getPUrl() {
    return pUrl;
}
void
SamiSourceInput::setPUrl(String* pUrl) {
    this->pUrl = pUrl;
}

String*
SamiSourceInput::getPLogoUrl() {
    return pLogo_url;
}
void
SamiSourceInput::setPLogoUrl(String* pLogo_url) {
    this->pLogo_url = pLogo_url;
}

Boolean*
SamiSourceInput::getPEnabled() {
    return pEnabled;
}
void
SamiSourceInput::setPEnabled(Boolean* pEnabled) {
    this->pEnabled = pEnabled;
}

Boolean*
SamiSourceInput::getPCustomRssFeed() {
    return pCustom_rss_feed;
}
void
SamiSourceInput::setPCustomRssFeed(Boolean* pCustom_rss_feed) {
    this->pCustom_rss_feed = pCustom_rss_feed;
}

String*
SamiSourceInput::getPRssPublisher() {
    return pRss_publisher;
}
void
SamiSourceInput::setPRssPublisher(String* pRss_publisher) {
