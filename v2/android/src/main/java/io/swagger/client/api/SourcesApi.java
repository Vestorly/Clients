...
public class SourcesApi {
  ...
  public Void  index (String vestorly-auth, String ids) throws ApiException {
    ...
    String path = "api/sources.json".replaceAll("\\{format\\}","json");
  ...
  public Void  show (String vestorly-auth, String id) throws ApiException {
    ...
    // create path and map variables
    String path = "api/sources/{id}.json".replaceAll("\\{format\\}","json").replaceAll("\\{" + "id" + "\\}", apiInvoker.escapeString(id.toString()));
  ...
  public Void  update (String id, String source) throws ApiException {
    Object postBody = null;
