...
+(SWGSessionApi*) apiWithHeader:(NSString*)headerValue key:(NSString*)key {
    static SWGSessionApi* singletonAPI = nil;

    if (singletonAPI == nil) {
        singletonAPI = [[SWGSessionApi alloc] init];
...
-(NSNumber*) logoutWithCompletionBlock: (NSString*) vestorly-auth
    ...
    NSMutableString* requestUrl = [NSMutableString stringWithFormat:@"%@/sessions/m", basePath];
