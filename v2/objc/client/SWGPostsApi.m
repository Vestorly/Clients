...
-(NSNumber*) indexWithCompletionBlock: (NSString*) vestorly-auth
    ...
    NSMutableString* requestUrl = [NSMutableString stringWithFormat:@"%@api/posts.json", basePath];
...
-(NSNumber*) showWithCompletionBlock: (NSString*) vestorly-auth
    ...
    NSMutableString* requestUrl = [NSMutableString stringWithFormat:@"%@api/posts/{id}.json", basePath];
