...
-(NSNumber*) indexWithCompletionBlock: (NSString*) vestorly-auth
    ...
    NSMutableString* requestUrl = [NSMutableString stringWithFormat:@"%@api/events.json", basePath];
...
-(NSNumber*) showWithCompletionBlock: (NSString*) vestorly-auth
    ...
    NSMutableString* requestUrl = [NSMutableString stringWithFormat:@"%@api/events/{id}.json", basePath];
