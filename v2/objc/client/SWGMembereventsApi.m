...
-(NSNumber*) findMemberEventsWithCompletionBlock: (NSString*) vestorlyAuth
    ...
    NSAssert(vestorlyAuth != nil, @"Missing the required parameter `vestorlyAuth` when calling findMemberEvents");
