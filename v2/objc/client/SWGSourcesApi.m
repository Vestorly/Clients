...
-(NSNumber*) indexWithCompletionBlock: (NSString*) vestorly-auth
    ...
    NSMutableString* requestUrl = [NSMutableString stringWithFormat:@"%@api/sources.json", basePath];
...
-(NSNumber*) showWithCompletionBlock: (NSString*) vestorly-auth
    ...
    NSMutableString* requestUrl = [NSMutableString stringWithFormat:@"%@api/sources/{id}.json", basePath];
